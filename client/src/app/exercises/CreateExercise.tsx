...
export default function CreateExercise({
  ...
  return (
    <div className="p-6 flex flex-col rounded-lg bg-card text-card-foreground shadow-2xs border-2 border-blue-100 hover:border-blue-200 transition-colors">
      <div className="space-y-1.5">
        <div className="flex items-start justify-between">
          <div className="p-3 rounded-lg bg-blue-200 bg-opacity-10">{icon}</div>
          <h3 className="tracking-tight text-xl font-bold text-blue-700 text-center">
            {name}
          </h3>
          <div
            className={clsx(
